...
<html lang="en">
    <head>
        ...
        <!-- google font -->
        <link href="<?php echo ACSS; ?>/aclonica.css" rel="stylesheet" type="text/css" />

        <!-- styles -->
        <link href="<?php echo ACSS; ?>/bootstrap.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/bootstrap-responsive.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/stilearn.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/stilearn-responsive.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/stilearn-helper.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/stilearn-icon.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/font-awesome.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/animate.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/uniform.default.css" rel="stylesheet" />

        <link href="<?php echo ACSS; ?>/select2.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/fullcalendar.css" rel="stylesheet" />
        <link href="<?php echo ACSS; ?>/bootstrap-wysihtml5.css" rel="stylesheet" />

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
          <script src="<?php echo AJS; ?>/html5.js"></script>
        <![endif]-->
    ...
    <body>
                        ...
                        <div class="panel-ext">
                                ...
                                <ul class="dropdown-menu dropdown-notification">
                                    ...
                                    <li class="new">
                                        <a href="#">
                                            ...
                                            <div class="media">
                                                <img class="media-object pull-left" data-src="<?php echo AJS; ?>/holder.js/64x64" />
                            ...
                            <div class="btn-group user-group">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                    <img class="corner-all" align="middle" src="<?php echo AIMG; ?>/user-thumb.jpg" title="John Doe" alt="john doe" /> <!--this for display on PC device-->
                                    ...
                                    <li>
                                        <div class="media">
                                            <a class="pull-left" href="#">
                                                <img class="img-circle" src="<?php echo AIMG; ?>/user.jpg" title="profile" alt="profile" />
                                            </a>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="recent-orders">
                                                    <div class="media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object" data-src="<?php echo AJS; ?>/holder.js/64x64" />
                                                        </a>
                                                        <div class="media-body">
                                                ...
                                                <li class="contact-alt grd-white">
                                                    ...
                                                    <a href="#chat" data-toggle="tab" data-id="iin@mail.com">
                                                        ...
                                                        <div class="contact-item">
                                                            <div class="pull-left">
                                                                <img class="contact-item-object" style="width: 32px;height: 32px;" src="<?php echo AIMG; ?>/user-thumb-mini.jpg" />
                                                            </div>
                                        ...
                                        <div class="side-task">
                                            <div class="task active">
                                                <span class="task-header">
                                                    <img src="<?php echo AIMG; ?>/loader_16.gif" />
        ...
        <!-- javascript
        ================================================== -->
        <script type="text/javascript" src="<?php echo AJS; ?>/widgets.js"></script>
        <script src="<?php echo AJS; ?>/jquery.js"></script>
        <script src="<?php echo AJS; ?>/jquery-ui.min.js"></script>
        <script src="<?php echo AJS; ?>/bootstrap.js"></script>
        <script src="<?php echo AJS; ?>/uniform/jquery.uniform.js"></script>
        <script src="<?php echo AJS; ?>/peity/jquery.peity.js"></script>

        <script src="<?php echo AJS; ?>/select2/select2.js"></script>
        <script src="<?php echo AJS; ?>/knob/jquery.knob.js"></script>
        <script src="<?php echo AJS; ?>/flot/jquery.flot.js"></script>
        <script src="<?php echo AJS; ?>/flot/jquery.flot.resize.js"></script>
        <script src="<?php echo AJS; ?>/flot/jquery.flot.categories.js"></script>
        <script src="<?php echo AJS; ?>/wysihtml5/wysihtml5-0.3.0.js"></script>
        <script src="<?php echo AJS; ?>/wysihtml5/bootstrap-wysihtml5.js"></script>
        <script src="<?php echo AJS; ?>/calendar/fullcalendar.js"></script> <!-- this plugin required jquery ui-->

        <!-- required stilearn template js, for full feature-->
        <script src="<?php echo AJS; ?>/holder.js"></script>
        <script src="<?php echo AJS; ?>/stilearn-base.js"></script>
